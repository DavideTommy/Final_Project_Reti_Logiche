...
funcp funcTab[4] = {(funcp)execute_29, (funcp)execute_30, (funcp)transaction_0, (funcp)vhdl_transfunc_eventcallback};
const int NumRelocateId= 4;

void relocate(char *dp)
{
	iki_relocate(dp, "xsim.dir/project_reti_logiche_behav/xsim.reloc",  (void **)funcTab, 4);
	iki_vhdl_file_variable_register(dp + 9336);
	iki_vhdl_file_variable_register(dp + 9392);
...
int main(int argc, char **argv)
{
    ...
    void* design_handle = iki_create_design("xsim.dir/project_reti_logiche_behav/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, 0, isimBridge_getWdbWriter(), 0, argc, argv);
